# maintain a user model with the name, likes and dislikes, and personal information.
# this is going to be a simple text file
# retrieve information using similarity measures to the knowledge base
# hard code basic greetings
# hard code checking the chatbot's understanding
...
rand_sentences = ["Could you tell me more?","I see.","Could you elaborate?","Tell me more.","Could you tell me a little more about that?"]
